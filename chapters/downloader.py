...
#download all java source code from http://jcip.java.net.s3-website-us-east-1.amazonaws.com/listings.html
...
url = 'http://jcip.java.net.s3-website-us-east-1.amazonaws.com/'
source = urllib.urlopen('http://jcip.java.net.s3-website-us-east-1.amazonaws.com/listings.html')
